;; harvest-pro
;; 
;; This contract implements an agricultural yield tracking system on the Stacks blockchain.
;; It allows farmers to register, manage fields, record planting and harvesting events,
;; and enables verification by third parties across the agricultural supply chain.
;; The contract creates transparency and trust in agricultural production data by
;; maintaining an immutable record of crop yields and related metadata.
